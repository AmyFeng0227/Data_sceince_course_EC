...
from tensorflow.keras.layers import GlobalMaxPooling2D, Conv2D, MaxPooling2D, Flatten, Dense, Dropout, GlobalAveragePooling2D, BatchNormalization, Activation, Input
...
from functions_data_preprocessing import train_val_test_preprocessing, train_set_aug_and_preprocess
...
from functions_multitask_learning import load_utkface_data, build_multi_task_model
...
epochs = 100
model_save_name = "model_multitask_2.h5"
plot_name = 'plot_model_multitask_2.jpg'
training_history_file_name='training_history_multitask_2.json'
...
base_model = ResNet50V2(include_top=False, weights='imagenet', input_shape=(image_size, image_size, 3))
...
plot_training_history(training_history, folder_path + "/training_results/")
